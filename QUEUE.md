...
### AGENT lane
_All scoped bug work (B1, B2 incl. polish, B4/B5) implemented and verified headless; manual fully updated to match. Only user-side B1 Tier-2 (longer Focusrite listen / delay-at-96k) remains — short test already clean (no clicks). Branch unpushed._
