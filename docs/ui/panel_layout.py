...
CONTROLS = [
    ...
    *[_c(f"snap{r*8+i+1}", "button",
    ...
    _c("xp_page", "switch", dict(x=1734, y=752, w=312, labels=["GRAIN", "TAPE", "DELAY", "FILTR", "SMEAR", "ENV", "PITCH", "SPACE"], sel=3, title="PAGE"),
       ("special", "xp_page"), lo=0, hi=7, default=0, init_send=False),
    _c("xp_param", "switch", dict(x=1734, y=800, w=312, labels=["1", "2", "3", "4", "5", "6", "7", "8"], sel=1, title="PARAM"),
